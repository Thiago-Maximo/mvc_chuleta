<?php
require_once '../../controller/Controller_produtos_insere.php';
require_once '../../model/connectPDO.php'; // Conexão com o banco de dados

// Instanciar o controlador e obter os tipos de produto
$produtoController = new ProdutoController($pdo);
$tipos = $produtoController->obterTipos();

if ($_POST) {
    $produtoController->inserirProduto($_POST, $_FILES);
}
?>
        ...
        <div class="col-xs-12 col-sm-offset-2 col-sm-6 col-md-8">
            ...
            <div class="thumbnail">
                <div class="alert alert-danger" role="alert">
                    <form action="produtos_insere.php" method="post" enctype="multipart/form-data" id="form_insere">
                        ...
                        <div class="input-group">
                            ...
                            <select name="id_tipo" id="id_tipo" class="form-control" required>
                                <?php foreach ($tipos as $tipo) { ?>
                                    <option value="<?= $tipo['id'] ?>"><?= $tipo['rotulo'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <label for="destaque_n" class="radio-inline">
                                <input type="radio" name="destaque" value="Não" checked>Não
                            </label>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <img src="" id="imagem" class="img-responsive">
                            <input type="file" name="imagemfile" id="imagemfile" class="form-control" accept="image/*" required>
                        </div>

                        <br>
                        <input type="submit" name="enviar" class="btn btn-danger btn-block" value="Cadastrar">
                    </form>
                </div>
            </div>
        </div>
